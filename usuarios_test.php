            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    ...
                    <div class="card">
                                    ...
                                    <div class="card-body">
                                        <button type="button" class="btn btn-info" onclick='nuevo_cliente();'>Ventas</button>
                                        <button type="button" class="btn btn-success" id="watch-me">Cancelaciones </button>
                                        <button type="button" class="btn btn-primary" id="see-me">Corte de caja</button>
                                    </div>
