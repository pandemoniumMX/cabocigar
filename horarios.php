                                ...
                                <table id="a-tables" class="table table-hover table-dark table-responsive">
                                        ...
                                        <?php } ?>
                                                                        ...
                                                                        <?php
                                                                            ...
                                                                            echo "        
                                                                            <a href='#' onclick='expo(), update_ex_fn();' title='Transferir' ><i class='btn-sm btn-danger fa fa-bolt'></i></a>    
                                                                            <a href='modificar_empresa_car.php'  title='Aumentar' ><i class='btn-sm btn-info fa fa-star'></i></a>                                                      
                                                                                                                 
                                                                            <a href='recepcion_historial_cliente.php'  title='Dar de baja'><i class='btn-sm btn-primary fa fa-picture-o'></i></a>
                                                                            
                                                                            <a href='recepcion_historial_cliente.php'  title='Ver foto'><i class='btn-sm btn-primary fa fa-picture-o'></i></a>
                                                                            </td>"; 
